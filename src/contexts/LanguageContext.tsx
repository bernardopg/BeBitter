...
const translations = {
  pt: {
    ...
    'projects.portfolio.description': 'Portfolio moderno e responsivo construído com React e TypeScript, com design limpo e animações suaves.',
    'projects.tools.title': 'Ferramentas de Desenvolvimento Web',
    'projects.tools.description': 'Coleção de scripts utilitários e ferramentas para otimização do fluxo de trabalho de desenvolvimento web.',
  ...
  en: {
    ...
    'projects.portfolio.description': 'Modern, responsive portfolio built with React and TypeScript, featuring clean design and smooth animations.',
    'projects.tools.title': 'Web Development Tools',
    'projects.tools.description': 'Collection of utility scripts and tools for web development workflow optimization.',
