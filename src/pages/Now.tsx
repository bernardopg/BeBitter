  ...
  return (
    <>
      <SEOHead
        ...
        keywords={["now", "projetos atuais", "desenvolvimento web", "bernardo gomes", "programador", "foco atual", "conquistas"]}
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        >
          ...
          >
            {t("now.description")} {currentTime.toLocaleDateString(language === "pt" ? "pt-BR" : "en-US")}
          </motion.p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {currentFocus.map((item, index) => (
              <motion.div
                ...
                animate={focusInView ? { opacity: 1, scale: 1, y: 0 } : { opacity: 0, scale: 0.8, y: 30 }}
